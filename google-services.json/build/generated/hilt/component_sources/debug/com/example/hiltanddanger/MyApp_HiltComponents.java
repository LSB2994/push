...
import com.example.hiltanddanger.di.AppModule;
import com.example.hiltanddanger.view.UserVm_HiltModules;
import dagger.Binds;
...
public final class MyApp_HiltComponents {
  ...
  @Subcomponent(
      modules = {
          ...
          UserVm_HiltModules.KeyModule.class
      }
  )
  ...
  @Subcomponent(
      modules = {
          ...
          UserVm_HiltModules.BindsModule.class
      }
  )
  @ViewModelScoped
