...
import com.example.hiltanddanger.di.AppModule_ProvideApiServiceFactory;
import com.example.hiltanddanger.di.AppModule_ProvideDataSourceFactory;
import com.example.hiltanddanger.di.AppModule_ProvideLoginRepoFactory;
import com.example.hiltanddanger.di.AppModule_ProvideOkHttpClientFactory;
import com.example.hiltanddanger.di.AppModule_ProvideRetrofitFactory;
...
public final class DaggerMyApp_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends MyApp_HiltComponents.ActivityC {
    ...
    public Map<Class<?>, Boolean> getViewModelKeys() {
      return LazyClassKeyMap.<Boolean>of(Collections.<String, Boolean>singletonMap(LazyClassKeyProvider.com_example_hiltanddanger_view_UserVm, UserVm_HiltModules.KeyModule.provide()));
    }
    ...
    private static final class LazyClassKeyProvider {
      static String com_example_hiltanddanger_view_UserVm = "com.example.hiltanddanger.view.UserVm";

      @KeepFieldType
      UserVm com_example_hiltanddanger_view_UserVm2;
    }
  }
  ...
  private static final class ViewModelCImpl extends MyApp_HiltComponents.ViewModelC {
    ...
    private void initialize(final SavedStateHandle savedStateHandleParam,
      ...
      this.userVmProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 0);
    }

    @Override
    public Map<Class<?>, javax.inject.Provider<ViewModel>> getHiltViewModelMap() {
      return LazyClassKeyMap.<javax.inject.Provider<ViewModel>>of(Collections.<String, javax.inject.Provider<ViewModel>>singletonMap(LazyClassKeyProvider.com_example_hiltanddanger_view_UserVm, ((Provider) userVmProvider)));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.example.hiltanddanger.view.UserVm 
          return (T) new UserVm(singletonCImpl.provideLoginRepoProvider.get());
  ...
  private static final class SingletonCImpl extends MyApp_HiltComponents.SingletonC {
    ...
    private Provider<ArticleService> provideApiServiceProvider;

    private Provider<DataSource> provideDataSourceProvider;

    private Provider<Repository> provideLoginRepoProvider;
    ...
    private void initialize(final AppModule appModuleParam) {
      ...
      this.provideApiServiceProvider = DoubleCheck.provider(new SwitchingProvider<ArticleService>(singletonCImpl, 2));
      this.provideDataSourceProvider = DoubleCheck.provider(new SwitchingProvider<DataSource>(singletonCImpl, 1));
      this.provideLoginRepoProvider = DoubleCheck.provider(new SwitchingProvider<Repository>(singletonCImpl, 0));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.example.hiltanddanger.remote.repository.Repository 
          return (T) AppModule_ProvideLoginRepoFactory.provideLoginRepo(singletonCImpl.appModule, singletonCImpl.provideDataSourceProvider.get());

          case 1: // com.example.hiltanddanger.remote.datasource.DataSource 
          return (T) AppModule_ProvideDataSourceFactory.provideDataSource(singletonCImpl.appModule, singletonCImpl.provideApiServiceProvider.get());

          case 2: // com.example.hiltanddanger.remote.ArticleService 
          return (T) AppModule_ProvideApiServiceFactory.provideApiService(singletonCImpl.appModule, singletonCImpl.provideRetrofitProvider.get());

          case 3: // retrofit2.Retrofit 
          return (T) AppModule_ProvideRetrofitFactory.provideRetrofit(singletonCImpl.appModule, singletonCImpl.provideOkHttpClientProvider.get());

          case 4: // okhttp3.OkHttpClient 
          return (T) AppModule_ProvideOkHttpClientFactory.provideOkHttpClient(singletonCImpl.appModule);
